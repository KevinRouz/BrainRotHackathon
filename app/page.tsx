...
const cards = [
  { title: 'Brain Nourishment', description: "Education, the ocky way.", gradient: 'bg-gradient-to-br from-purple-500 to-pink-500', image: '/chill-guy.png', route: '/rotucate' },
  { title: 'Rizzlator6000', description: 'Skibidi rizzify your messages.', gradient: 'bg-gradient-to-br from-blue-500 to-teal-500', image: '', route: '/rizzlator6000' },
  { title: 'PolloDF', description: 'Call upon Don Pollo to brainrotify your PDFs.', gradient: 'bg-gradient-to-br from-yellow-500 to-red-500', image: '', route: '/pollodf' },
  ...
  { title: 'We\'re Chill Guys', description: 'I\'m just a chill guy, what more is there to say?', gradient: 'bg-gradient-to-br from-red-500 to-blue-500', image: '', route: '/chillguy' },
