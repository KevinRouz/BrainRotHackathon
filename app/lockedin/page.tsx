          ...
          <>
            ...
            {(['Promoting a product', 'Talking about my journey', 'An event that I went to', 'Other'] as PostType[]).map((type) => (
              <Button
                ...
                className="mb-2 w-full bg-white text-blue-500 hover:bg-blue-500 hover:text-white transition-colors"
              >
                {type}
              </Button>
            ))}
      ...
      case 3:
        return (
          <>
            ...
            />
            <Button onClick={() => setStep(4)} className="w-full bg-white text-blue-500 hover:bg-blue-500 hover:text-white transition-colors">
              Next
            </Button>
          </>
        );
      case 4:
        return (
          <>
            ...
            <Button onClick={() => setStep(5)} className="w-full bg-white text-blue-500 hover:bg-blue-500 hover:text-white transition-colors">
              Next
            </Button>
          </>
        );
        ...
        return (
          <>
            ...
            <textarea
              ...
              rows={4}
            />
            <Button onClick={handleSubmit} disabled={loading} className="w-full bg-white text-blue-500 hover:bg-blue-500 hover:text-white transition-colors">
      ...
      case 6:
        return (
          <>
            ...
            <Button onClick={() => setStep(1)} className="w-full bg-white text-blue-500 hover:bg-blue-500 hover:text-white transition-colors">
              Create Another Post
            </Button>
          </>
        );
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-green-500 to-blue-500 p-4">
      ...
      <Button 
        ...
        className="mt-8 bg-white text-blue-500 hover:bg-blue-500 hover:text-white transition-colors"
      >
        Back to Home
      </Button>
    </div>
